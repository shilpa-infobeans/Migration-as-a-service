    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Add Mapping</h1>
                <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    <i class="fas fa-download fa-sm text-white-50"></i> Guide to Check
                </a>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6 col-md-6 mb-4 ">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Select Source
                                        Database</div>
                                    <form class="py-4">
                                        <div class="form-group row">
                                            <label for="text1" class="col-4 col-form-label">Select Connections</label>
                                            <div class="col-8">
                                ...
                                <div class="col mr-2">
                                    <div class="form-group row">
                                        <div class="col-12 textcenter">
                                            <button type="button" class="btn btn-primary">Drupal to WordPress
                                                Migration</button>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 mb-4 ">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Create
                                            Entity to Migrate Database</div>
                                    </div>
                                    <form action="/mg/add_mapping.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="col-6">
                                                <button type="submit" name="create_entity" value="Create Entity"
                                                    class="btn btn-primary">Create Entity</button>
                                            </div>
                    ...
                    <div class="card border-left-primary shadow h-100 py-2" id="users-migration">
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-12 textcenter">
                                        <button type="button" class="btn btn-primary">One to many Migration</button>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <select class="form-control">
                                            ...
                                            <option selected>Table 2</option>
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control">
                                            ...
                                            <option>uaddress</option>
                                            <option>upin</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <button name="submit" type="button" class="btn btn-primary">Join</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                        <div>
                                                            <button name="submit" type="button"
                                                                class="btn btn-primary">Add Column</button>
                                                        </div>
                                                    </div>
                                        </form>
                                    </div>
