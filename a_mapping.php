                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6 col-md-6 mb-4 ">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Select Source Database</div>
                                    <form class="py-4">
                                ...
                                <div class="col-xl-6 col-md-6 mb-4 ">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Select Destination Database</div>
                                    <form class="py-4">
                                        <div class="form-group row">
                                            <label for="text1" class="col-4 col-form-label">Select Connections</label> 
                                            <div class="col-8">
                                ...
                                <div class="col mr-2">
                                    <div class="form-group row">
                                        <div class="col-12 textcenter">
                                            <button type="button" class="btn btn-primary">Drupal to WordPress Migration</button>    
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 mb-4 ">
                                    ...
                                    <form action="/mg/add_mapping.php" method="POST">
                                        <div class="form-group">
                                            <div class="col-12">
                                                <input  type="text" class="form-control" name="entity" placeholder="Add entity name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-xl-2 col-md-2 mb-2 ">
                                    ...
                                    <form class="py-4">
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                <button name="submit" type="button" class="btn btn-primary">Add Table</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-xl-3 col-md-3 mb-3 ">
                                    ...
                                    <form class="py-4">
                                        ...
                                        <!-- <div class="form-group form-row">
                                            ...
                                            <div class="col">
                                                <input type="text" class="form-control" placeholder="Meta Key">
                                            </div>
                                            <div class="form-row">
                                                <div class="col-6">
